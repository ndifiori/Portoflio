...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className='home__title'> Nate Difiori 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      I am a Software Engineer based in Irvine, California. I'm passionate about creating high quality products and solving complex problems! 
      </p>
