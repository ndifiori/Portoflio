  ...
  return (
    <header className='header'>
      ...
      <nav className='nav container'>
        <a href="index.html" className="nav__logo"> Difiori </a>
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu" }>
          < ul className='nav__list grid'>
            ...
            <li className='nav__item'>
              <a href="https://github.com/ndifiori?tab=repositories" target={'_blank'} onClick={() => setActiveNav('#portfolio')} className={activeNav === '#portfolio' 
              ? 'nav__link active__link' 
              : 'nav__link'}
              >
